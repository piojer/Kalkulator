...
//if (isset($_GET['netto'])) {
	...
	*/
	...
	echo "<H1 style='text-align:center'> Kalkulator wynagrodzeń za Nowej Prawicy </H1>";
	echo "<table>";
	echo "<tr><td width='50%' rowspan='1'>";
	$n = $netto + $nettod;
	echo "<font style='font-size:24'>Jeśli zarabiasz netto $n zł</font><font style='font-size:24'> i masz rodzinę $dorosli+$dzieci </font><br/><font style='font-size:30'>to oferuję Ci podwyżkę <b>$zyskNaCenyR zł</b></font>"; 
