...
function wypiszInputy(){
	...
	echo "<input type='submit' value='najczęstsze (dominanta)' name='dominanta'>";
	echo "<input type='submit' value='mediana wynagrodzeń' name='mediana'>";
	echo "<input type='submit' value='średnia' name='srednia'>";
	echo "<br/><input type='submit' name='niep' value='teraz na czasie: rodzina z niepełnosprawnym dzieckiem'>";
...
//if (isset($_GET['netto'])) {
	...
	wypisz("Twoje wynagrodzenie brutto", $brutto, "Wzięte z kalkulatorów wynagrodzenia brutto-netto");
	...
	*/
	...
	$przedZerowym = $kwota;
	obnizenie('jakVat', 2, 100, &$kwota, 'Inflacja', "Średnio inflacja to 2% w skali roku", $netto_r);
	...
	obnizenie('procentowo', $pp*$ulamekZatrudnionychUmowaOPrace*(100-$kocztyNiepracownicze)/100, 100, &$kwota, 'Koszty zatrudniena pracownika', "Szacuję, ze około $pracC % kosztów pracodawcy to koszty związane z wynagrodzeniami (Uwaga: wartość wyssana z palca: potrzebuję źródła) Z tego $uZoPc % to umowy o pracę (źródło: <a href='http://www.bankier.pl/wiadomosc/Umowy-smieciowe-to-mit-Pracuje-na-nich-tylko-600-tys-osob-2794604.html' >bankier.pl</a>).<br/>"
	...
	echo "<H1 style='text-align:center'> Kalkulator wynagrodzeń Nowej Prawicy </H1>";
	echo "<table width ='100%' height='70%'>";
	echo "<tr><td width='50%' height='30%'>";
	echo "<font style='font-size:24'>Jeśli zarabiasz netto $netto zł</font><font style='font-size:24'> i masz rodzinę $dorosli+$dzieci </font><br/><font style='font-size:30'>to oferuję Ci podwyżkę <b>$zyskNaCenyR zł</b></font>"; 
	...
	echo "<li>Ile przypada uczniów na 1 nauczyciela (Założyłem, że jest 1000zł co 3 lata + 35 tys.zł raz na 50 lat)</li>";
